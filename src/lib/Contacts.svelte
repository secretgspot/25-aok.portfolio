...
<section class="container">
	{#if success}
		<div class="success">
			...
			<p>
				<strong>Thanks for reaching out!</strong><br /> I'll be in touch.
			</p>
		</div>
	{:else}
		...
		<form
			...
			<textarea class="form-input" id="message" name="message" placeholder="Message"
			></textarea>
...
<style>
	...
	button {
		...
		&:active {
			top: 2px;
			box-shadow: 0 0 0 0 var(--surface-1);
		}

		transition: transform 0.2s cubic-bezier(0.01, 0.29, 0.38, 2.37);
	}
</style>
